...
public class BoardVOTest {
	...
	public static void main(String[] args) {
		...
		boardVO.setContent("java study");
		boardVO.setWriter("Ko");
		...
		// boardVO라는 객체에 데이터가 잘 들어가 있는지 확인해 보자.
		System.out.println(boardVO.toString());
		System.out.println(boardVO);

		// 기본 생성자가 아닌 생성자의 테스트
		// 값이 이미 정해져 있어서 객체를 생성하면서 데이터를 초기화 시킬 수 있다.
		BoardVO boardVO1 = new BoardVO(10, "test", "testContent", "testKO", "test2020.12.23", 20);
		BoardVO boardVO2 = new BoardVO(10, "test", "testContent", "testKO", "test2020.12.23", 20);
		// 출력하는데 객체이름만 사용한 경우 toString 메서드를 자동 호출 한다.
