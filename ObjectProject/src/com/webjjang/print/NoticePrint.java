/*
 * 공지 게시판 처리 결과를 출력하는 객체 1. list - print(List), 2. view - print(vo), 3. write/4.update/5.delete -
 * print(int result, String msg) 작성일 : 2021.01.19 작성자 : 고선호
 */
...
public class NoticePrint {
	...
	public static void print(List<NoticeVO> list) {
		...
		int cnt = 80;
		// 제목 출력
		Output.title("공지 게시판 리스트");
		// 항목 이름 출력
		// Output.printWithLine(가운데 출력할 문자열, 위아래 라인 출력 문자, 반복횟수)
		Output.printWithLine(" 글번호 / 제목 / 공지시작일 / 공지종료일 / 공지수정일", "-", cnt);
		// 데이터 출력
